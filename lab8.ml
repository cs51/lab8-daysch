...
......................................................................*)
  ...
  let fire_event (evt : 'a event) (arg : 'a) : unit =
    let _ =
    List.fold_left (fun _ {action} -> action arg) () !evt in ()
end
...
(* .. *)
WEvent.remove_listener newswire fnn;;
WEvent.remove_listener newswire bf;;
...
let receive_report s : unit =
  let _ =
    WEvent.add_listener publish (fun () -> fakeNewsNetwork s) in
  let _ =
    WEvent.add_listener publish (fun () -> buzzFake s) in
  () ;;
